...
INSERT IGNORE INTO users (id, email, password, creationdate, idP) VALUES 
(1, "user@example.com", SHA2(CONCAT(NOW(), "user"), 224), NOW(), 33),
(40, "admin@example.com", SHA2(CONCAT(NOW(), "passAdmin"), 224), NOW(), 40);
/*
