...
INSERT IGNORE INTO users (id, email, password, creationdate,admin, idP) VALUES 
(1, "user@example.com", SHA2(CONCAT(NOW(), "user"), 224), NOW(),false, 33),
(40, "admin@example.com", SHA2(CONCAT(NOW(), "passAdmin"), 224), NOW(),true, 40);
